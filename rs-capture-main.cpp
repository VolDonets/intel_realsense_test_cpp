...
int main(int argc, char * argv[]) try
{
    ...
    for (int counter = 0; counter < 1000000; counter++) // Application still alive?
    {
        ...
        cv::imshow("win1", cv_frame_depth);
        cv::waitKey(0);

        //std::string img_col_name = "img_color_" + std::to_string(counter) + ".png";
        //cv::imwrite(img_col_name, cv_frame_color);
        //std::string img_depth_name = "img_depth_" + std::to_string(counter) + ".png";
